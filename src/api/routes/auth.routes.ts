...
router
  ...
  .post(
    ...
    (req: Request, res: Response, next: NextFunction) =>
      UserCtrl.create_a_user(req, res, next)
  );
router
  .route("/login")
  .post(
...
router
  ...
  .post(auth, (req: Request, res: Response) =>
    UserCtrl.createOrderCtrl(req, res)
  );
router
  .route("/cart")
  .post(auth, (req: Request, res: Response) => UserCtrl.userCartCtrl(req, res));
router
  .route("/cart/applycoupon")
  .post(auth, (req: Request, res: Response) =>
    UserCtrl.applyCouponCtrl(req, res)
  );

router
  .route("/save-address")
  .put(auth, (req: Request, res: Response) => UserCtrl.saveAddress(req, res));
router
  .route("/wishlist")
  .put(auth, (req: Request, res: Response) => UserCtrl.addToWishList(req, res));
...
router
  ...
  .get((req: Request, res: Response, next: NextFunction) =>
    UserCtrl.handleRefreshToken(req, res, next)
  );
router
  .route("/logout")
  .get((req: Request, res: Response, next: NextFunction) =>
    UserCtrl.logoutUserCtrl(req, res)
  );
router
  .route("/user-cart")
  .get(auth, (req: Request, res: Response) =>
    UserCtrl.getUserCartController(req, res)
  );
router
  .route("/get-orders")
  .get(auth, (req: Request, res: Response) =>
    UserCtrl.getOrdersController(req, res)
  );
router
  .route("/empty-cart")
  .delete(auth, (req: Request, res: Response) =>
    UserCtrl.emptyCartCtrl(req, res)
  );
router
  .route("/getallorders")
  .get(auth, isAdmin, (req: Request, res: Response, next: NextFunction) =>
    UserCtrl.getAllOrdersController(req, res, next)
  );
router
...
router
  ...
  .patch((req: Request, res: Response, next: NextFunction) =>
    UserCtrl.passwordReset(req, res, next)
  );
router
  .route("/wishlist/:id")
  .get(auth, (req: Request, res: Response) => UserCtrl.getWishList(req, res));
router
  .route("/getorderbyuser/:id")
  .get(auth, isAdmin, (req: Request, res: Response) =>
    UserCtrl.getOrderByUserIDController(req, res)
  );
router
  .route("/:id")
  .get(
...
router
  ...
  .patch(
    ...
    validate(paramsSchema),
    (req: Request, res: Response, next: NextFunction) =>
      UserCtrl.blockUserCtrl(req, res, next)
  );
router
  ...
  .patch(
    ...
    validate(paramsSchema),
    (req: Request, res: Response, next: NextFunction) =>
      UserCtrl.UnBlockUserCtrl(req, res, next)
  );
router
  .route("/order/update-order/:id")
  .put(auth, isAdmin, (req: Request, res: Response) =>
    UserCtrl.UpdateOrderStatusController(req, res)
  );
